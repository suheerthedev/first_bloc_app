  ...
  static List<Map<String, dynamic>> groceryProducts = [
    {
      ...
      "inStock": true,
      "description":
          "Fresh, juicy red apples rich in fiber and vitamin C — perfect for a healthy snack.",
    },
    {
      "id": 2,
      "name": "Banana",
      ...
      "inStock": true,
      "description":
          "Sweet ripe bananas that are high in potassium and ideal for smoothies or snacks.",
    },
    {
      "id": 3,
      "name": "Milk",
      ...
      "inStock": true,
      "description":
          "Pure and fresh dairy milk, full of calcium and essential nutrients for daily health.",
    },
    {
      "id": 4,
      "name": "Bread",
      ...
      "inStock": false,
      "description":
          "Soft and fluffy milk bread, great for breakfast toasts, sandwiches, and more.",
    },
    {
      "id": 5,
      "name": "Eggs",
      ...
      "unit": "dozen",
      "imageUrl":
          "https://bluejeanchef.com/uploads/2019/04/Eggs-1280--640x800.jpg",
      "inStock": true,
      "description":
          "Farm-fresh eggs packed with protein — ideal for breakfast or baking needs.",
    },
  ];
}
